<template>
    <div style="margin-top: 30px">
        ...
        <input type="text" style="margin-left: 16px; margin-top: 10px;" v-model="issueInfo.creationDate" />
        <br />
        <span>Worker</span>
    ...
    <div style="margin-top: 20px">
        ...
        <input type="button" class="button" value="Delete" style="margin-left: 10px;" v-on:click="onDeleteClick(issueInfo)" />
